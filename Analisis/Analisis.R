# analisare los datos, ya agrupados
...
## Ahora voy mostrare la jerarquia II
...
names(emision_II_sep) <- c("energía", "procesos_industriales",  "uso_suelo", "desechos", "bunkers", "quema_biomasa", "agricultura")
for (i in c(1:7)) {
